...
[r,COUNT(cd,""),code:{              
   ...
   [r, if(  matches(key, ".*PunVida") && value >0): PerderPV(target,value)]
   [h, if(  matches(key, ".*PunVida") && value >0): sumaPv = sumaPv + value]
...
[r,if(sumaPv > 0): strformat("En total %{target} perdio en total %{sumaPv} Puntos de vida.") ; target + " No recibe danios."]
